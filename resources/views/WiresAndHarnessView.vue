	...
	<v-container fluid class="wires-and-harness-container">
		...
		<v-container class="shrink-width">
			<v-row>
				...
				<v-col lg="12" md="12" sm="12" cols="12">
					<p>
						<span>Prototyping</span> – we can make fully functional prototypes based off of your design - be it a 
					...
					<v-img class="ml-auto mr-auto" max-width="650px" max-height="450px" src="images/wiress-and-harness/prototype.jpg"></v-img>
				</v-col>
				<v-col lg="12" md="12" sm="12" cols="12" class="mt-6">
					<p>
						<span>Documenting</span> – we can make detailed documentation including drawings, BOMs and 
					...
					<v-img class="ml-auto mr-auto" max-width="650px" max-height="450px" src="images/wiress-and-harness/annotation.jpg"></v-img>
				</v-col>
				<v-col lg="12" md="12" sm="12" cols="12">
					<p>
						<span>Manufacture</span> – we can produce wire harnesses in greater quantities with no loss in 
				...
				<v-col lg="12" md="12" sm="12" cols="12">
					<p>
						<span>Quality control</span> – we send you the cable harnesses only after they have been thoroughly 
						tested by our quality control. This is very important to us, and we know it is very 
						important to our customers. 
					</p>
					<v-img class="ml-auto mr-auto" max-width="650px" max-height="450px" src="images/wiress-and-harness/clipboard.jpg"></v-img>
				</v-col>
				<v-col lg="12" md="12" sm="12" cols="12" class="mt-10">
					<p>
